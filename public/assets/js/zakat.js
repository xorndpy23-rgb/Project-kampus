...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Pilihan jenis zakat di kalkulator
    ...
    if (resetKalkulator) {
        resetKalkulator.addEventListener('click', function() {
    ...
    // Hitung zakat
    const hitungKalkulator = document.getElementById('hitungKalkulator');
    if (hitungKalkulator) {
        hitungKalkulator.addEventListener('click', function() {
            const activeType = document.querySelector('.zakat-type-btn.active').dataset.type;
            let totalHarta = 0;
    ...
    const gunakanHasil = document.getElementById('gunakanHasil');
    if (gunakanHasil) {
        gunakanHasil.addEventListener('click', function() {
    ...
    // Hitung ulang
    const hitungUlang = document.getElementById('hitungUlang');
    if (hitungUlang) {
        hitungUlang.addEventListener('click', function() {
            document.getElementById('hasilSection').style.display = 'none';
            document.getElementById('inputSection').style.display = 'block';
        });
    }
